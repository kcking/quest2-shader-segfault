...
pub fn main() {
    ...
    unsafe {
        ...
        //  THIS WORKS:
        let (vert, vert_entry) = (
            read_spv(&mut Cursor::new(&include_bytes!("fullscreen.vert.spv")[..])).unwrap(),
            b"main\0",
        );
        //  THIS CRASHES:
        // let (vert, vert_entry) = (
        //     read_spv(&mut Cursor::new(&include_bytes!("failing_shader.spv")[..])).unwrap(),
        //     b"vertex_fn\0",
        // );
